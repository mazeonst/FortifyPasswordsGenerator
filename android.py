...
# 4. Изменено окно "Сгенерированныче пароли"
...
class PasswordGeneratorApp(QWidget):
    ...
    def show_settings_window(self):
        ...
        capabilities_button = QPushButton("Возможности", dialog)
        ...
        tips_button = QPushButton("Советы", dialog)
...
<html>
                    ...
                    <body>
                            <h1>Возможности Fortify</h1>
                            <h2>1. Генерация сразу нескольких паролей</h2>
                            <p>Fortify обеспечивает возможность создания не только одного, но и нескольких уникальных паролей за один раз. Это особенно удобно, когда требуется сгенерировать набор паролей для различных учетных записей или сервисов.</p>
                            ...
                            <p>Fortify также предлагает функционал по шифрованию паролей, используя библиотеку "cryptography.fernet".</p>
                            <ol>
