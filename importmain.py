...
class PasswordDialog(QDialog):
    ...
    def encrypt_password(self):
        ...
        notification.notify("Пароль зашифрован", "Пароль успешно зашифрован!")
    ...
    def copy_password(self):
        ...
        # Отправляем уведомление
        notification.notify("Скопировано", "Пароль успешно скопирован в буфер обмена!")
    ...
    def save_password(self):
        ...
        if ok:
            ...
            # Отправляем уведомление
            notification.notify("Данные сохранены", "Пароль успешно сохранён!")
